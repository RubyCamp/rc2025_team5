...
Event.create!(
  ...
  geo_lat: '35.465056',
  geo_lng: '133.052399',
  descrimination: '松江水郷祭湖上花火大会は、島根県松江市の宍道湖で開催される日本有数の花火大会です。'
  )
...
Event.create!(
  ...
  descrimination: '「松江水燈路（読み方：まつえすいとうろ）」は、松江の秋の風物詩。松江城周辺がライトアップされる幻想的な光のイベントです。期間中は、松江城やその周辺に多くの行燈が並べられ、美しい風景を楽しむことができます。'
)
...
Event.create!(
    ...
    descrimination: 'ソメイヨシノの見ごろに合わせて、雲南市木次町のJR木次駅前商店街周辺を会場に「雲南市桜まつり」が開催されます。'
  )
